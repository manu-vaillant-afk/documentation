...
Select to which **tax group** the tax belongs. The tax group name is the displayed above the
...
.. example::
   ...
   is why the indicates :guilabel:`0% EU S`, and the tax group name above the :guilabel:`Total` line
   indicates :guilabel:`VAT 0%`.
